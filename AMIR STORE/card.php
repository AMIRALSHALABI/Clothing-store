                            ...
                            <div class="row">
                                <div class="col-xs-7 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="amir" name="cust_name"
                                            required />
                                    </div>
                                </div>
                                <div class="col-xs-5 col-md-5 pull-right">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" value="$ <?= $_SESSION['bill_amt'] ?>"
                                            disabled />
                            ...
                            <div class="row">
                                <div class="col-xs-7 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="asdf344@gma.com"
                                            name="email" required />
                                    </div>
                                </div>
                                <div class="col-xs-5 col-md-5 pull-right">
                            ...
                            <div class="row">
                                <div class="col-xs-7 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="is" name="bank_name"
                                            required />
                                    </div>
                                </div>
                                <div class="col-xs-5 col-md-5 pull-right">
                                    <div class="form-group">
                                        <label>CV CODE</label>
                                        <input type="number" class="form-control" placeholder="CVC" name="card_cvc"
                                            required />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-warning btn-lg btn-block" type="submit"
                                    name="process_payment">Process Payment</button>
                            </div>
                        </div><br>
                    </div>
                    </form>
