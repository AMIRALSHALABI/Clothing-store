...
<body>
        ...
        <tr>
            ...
            <td>
                <img style="border: 1px solid #ddd; border-radius: 4px;
                            padding: 5px; width: 75px;" src="images/products/<?=$value['image_name']?>"
            ...
            <td>
                <form action="server.php" method="post"><br>
                    ...
                    <input type="submit" onclick="return confirm('Are you sure you want to remove product from cart?')"
                        value="Delete from Cart" name="delete_from_cart">
                </form>
            </td>
            <?php
    ...
    <form action="server.php" method="post">
        ...
        <input type="submit" onclick="return confirm('Are you sure you want to checkout?')" value="Checkout"
            style="float: right; margin-right:168px" name="checkout">
    </form><br>
    <?php
    }else {            
    ?>
    ...
    <div style="float: right; color: #8B8000; margin-right: 168px">
        ...
        <div style="color:black">
            ...
            if($shoes_count == 0){?>
            Shoes <?php } ?>
            <br><br><a href="index.php">Shop more</a>
        </div>
        <br><br>
    </div>
    <br><br><br><br>
    ...
    <h3 style="text-align: center">Cart Empty! Shop some products by clicking <a href="index.php">here.</a></h3>
    <?php } ?>
    <br><br><br>
