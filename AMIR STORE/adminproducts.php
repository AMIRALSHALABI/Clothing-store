<?php 
  ...
  if (!isset($_SESSION['username'])) {
  	...
  	header('location: account2-1.php');
  }
    ...
    <div class="container" id="caps">
        ...
        <div class="categories">
            ...
            <form action="server.php" method="post">
                ...
                <input onclick="return confirm('Are you sure you want to delete this product?');" type="submit"
                    name="delete_product" value="Delete Product">
            </form>
        </div>
        <?php } 
        }?>
